...
//    Vector3D gridSpacing(0.02, 0.02, 0.02);
    ...
    std::ifstream positionFile(inputFilename.c_str(), std::ifstream::in);
    if (positionFile) 
    {   
        char v;
        float x1,y1,z1;
        ...
        {
        positionFile >>v >> x1 >> y1 >> z1 ;
        //printf("%f %f %f\n",x1,y1,z1);
        positions.append(Vector3D(x1,y1,z1)) ;
        /*
        std::vector<uint8_t> buffer(
            (std::istreambuf_iterator<char>(positionFile)),
            (std::istreambuf_iterator<char>()));
        printf("pre deserialize\n");

        deserialize(buffer, &positions);
        */
        }
        printf("Read points finished\n");
        positionFile.close();
    } else {
...
/*
g++ p2obj.cpp -I /home/DRIVE/Pesquisa2020/fluid-engine-dev/include/ -I /home/DRIVE/Pesquisa2020/fluid-engine-dev/external/ -I /home/DRIVE/Pesquisa2020/fluid-engine-dev/src/examples/ -I /home/DRIVE/Pesquisa2020/fluid-engine-dev/external/Clara/include/ -L /home/DRIVE/Pesquisa2020/fluid-engine-dev/build/lib/ -ljet -ltbb -lpystring -std=c++11 -o p2obj
*/
